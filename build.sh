...
echo "Building sdk-style csproj solution with dotnet build"
dotnet build /t:Restore /t:Build SdkCsproj/TestGitVersionCore.sln
...
echo "Building sdk-style csproj solution with dotnet msbuild"
dotnet msbuild /t:Restore /t:Build SdkCsproj/TestGitVersionCore.sln
